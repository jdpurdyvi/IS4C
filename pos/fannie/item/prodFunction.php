...
$query = sprintf("UPDATE products 
	...
	notes='%s',
	label_prints='%d'
	where upc = '%s'",$_POST['descript'],$_POST['price'],$wholesalecost,$_POST['tax'],$_POST['Scale'],$_POST['FS'],$_POST['department'],$_POST['subdepartment'],$_POST['inUse'],$_POST['QtyFrc'],$_POST['NoDisc'],$_POST['deposit'],$_POST['size'],$_POST['vendor'],$_POST['brand'],$_POST['notes'],$_POST['label_prints'],$_POST['upc']);
...
$query = sprintf("insert products (upc,description,normal_price,wholesale_cost,tax,scale,foodstamp,department,subdept,inUse,qttyEnforced,discount,modified,deposit,size,vendor,brand,notes,label_prints) values ('%s','%s',%f,%f,%d,%d,%d,%d,%d,%d,%d,%d,now(),%f,'%s','%s','%s','%s','%d')",$_POST['upc'],$_POST['descript'],$_POST['price'],$wholesalecost,$_POST['tax'],$_POST['Scale'],$_POST['FS'],$_POST['department'],$_POST['subdepartment'],$_POST['inUse'],$_POST['QtyFrc'],$_POST['NoDisc'],$_POST['deposit'],$_POST['size'],$_POST['vendor'],$_POST['brand'],$_POST['notes'],$_POST['label_prints']);
 echo "<br />";
	if (!mysql_query($query)) {
